...
/**
 * JUNIT
 * Write a junit that is capable of computing a metric distance value from an expression
 * that contains different scales and systems.
 * Output should be specified by the user.
 * Only Addition and subtraction is allowed.
 * Implement the junit and write unit tests that prove that the computations are correct.
